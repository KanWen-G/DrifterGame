...
credits.prototype = {
    create: function(){
        this.content = [
            "Thank you for playing Drifter, a CMPM120/ ARTG120 game presented by Tokyo Drift.",
            "",
            "Team members:",
            "",
            "Kan Wen - Programming, Art, Level Design",
            "",
            "Jorge Ortiz - Music, Programming, Sound Effects",
            "",
            "Zachery Wolfert - Level Design, Narrative, Art",
            "",
            "",
            "Special thanks to Tad Leckerman and Isaac Karth for teaching ARTG120 and CMPM120, and for teaching us the skills to make this game.",
            "",
            "",
        ...
        this.sound = game.add.audio('Game Music', 0.3);
        this.sound.loopFull();
